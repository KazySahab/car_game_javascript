document.addEventListener("keydown", function (input) {
    ...
    if (input.code == "KeyW"&&my_car.position.y>20) my_car.velocity.y = -5;
    if (input.code == "KeyS"&&my_car.position.y < height - 170) my_car.velocity.y = 5;
    if (input.code == "KeyD"&&my_car.position.x<(width / 2) + 110)my_car.velocity.x = 5;
    if (input.code == "KeyA"&&my_car.position.x>(width / 2) - 180) my_car.velocity.x = -5;
