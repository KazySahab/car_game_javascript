document.addEventListener("keydown", function (input) {
    ...
    if (input.code == "KeyW") my_car.velocity.y = -5;
    if (input.code == "KeyS") my_car.velocity.y = 5;
    if (input.code == "KeyD") my_car.velocity.x = 5;
    if (input.code == "KeyA") my_car.velocity.x = -5;
